var ltmp_ru_arr = {
	...
	terms_of_use_html: `
	<p class="boldest bigger">Манифест Readdle.me</p>
	...
	<p>Readdle.me <strong>меняет устоявшиеся правила.</strong> Он работает на блокчейне VIZ и использует протокол Голос.<br>
	Голос — <a href="https://github.com/VIZ-Blockchain/Free-Speech-Project/blob/master/README-ru.md" target="_blank">глобальный протокол</a> для социальной сети свободы слова.</p>
	...
	<ul>
		<li>Код Readdle.me — нейтральная технология, как веб-сайты или торренты.</li>
	...
	`,
	terms_of_use_accept: `Я прочел и соглашаюсь с условиями использования`,
};