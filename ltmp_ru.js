var ltmp_ru_arr={
	...
	manual_arr:{
		introduction:{title:'Введение',html:`
		...
		`},
		settings:{title:'Основное меню',html:`
		...
		tags:{title:'Тэги',html:`
			...
			<p>Тэги можно %%icon_pin%% закрепить или добавить в %%icon_eye_ignore%% игнорируемые, для этого нужно перейти в существующий тэг и нажать соответствующую иконку в шапке.</p>
			<p>Закрепленные тэги будут отображаться в правом меню на ПК версии и ниже основного меню на мобильной версии.</p>
			<p>При редактировании профиля можно задать интересы (пересекающиеся тэги) и категории (уникальные тэги), которые будут доступны при просмотре вашего профиля другим участникам. Используя их они смогут делать быструю выборку по вашим заметкам и публикациям.</p>
		`},
		publish:{title:'Публикации',html:`
		...
		`},
		storage:{title:'Хранение файлов',html:`
		...
		`},
		services:{title:'Микросервисы',html:`
